            ...
            <nav class="sticky top-0 z-50 bg-base-100 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-600">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('notes')" :active="route().current('notes')">
                                    Notes
                                </JetNavLink>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <JetResponsiveNavLink :href="route('tasks')" :active="route().current('tasks')">
                            Tasks
                        </JetResponsiveNavLink>
                         <JetResponsiveNavLink :href="route('notes')" :active="route().current('notes')">
                            Notes
                        </JetResponsiveNavLink>
