        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="overflow-hidden flex">
                    <div class="p-5 w-full dark:text-white text-gray-900">
                        <div>
                            <div>
                                <h2>
                                ...
                                <p class="mt-2">
                                    ...
                                    use of LifeDash's Website, located at https://gram.social.
                                </p>
                                <p class="mt-2">
                                    By accessing this website we assume you accept these terms and
                                    conditions. Do not continue to use LifeDash if you do not agree to take
                                ...
                                <p class="mt-2">
                                    We employ the use of cookies. By accessing LifeDash, you agreed to use
                                    cookies in agreement with the LifeDash's Privacy Policy.
                                </p>
                                <p class="mt-2">
                                ...
                                <p class="mt-2">
                                    Unless otherwise stated, LifeDash and/or its licensors own the
                                    intellectual property rights for all material on LifeDash. All
                                    intellectual property rights are reserved. You may access this from
                                    LifeDash for your own personal use subjected to restrictions set in
                                ...
                                <ul>
                                    <li>
                                        Republish material from LifeDash
                                    </li>
                                    <li>
                                        Sell, rent or sub-license material from LifeDash
                                    </li>
                                    <li>
                                        Reproduce, duplicate or copy material from LifeDash
                                    </li>
                                    <li>
                                        Redistribute content from LifeDash
                                    </li>
                                </ul>
                                <p class="mt-2">
                                ...
                                <p class="mt-2">
                                    ...
                                    LifeDash does not filter, edit, publish or review Comments prior to
                                    their presence on the website. Comments do not reflect the views and
                                    opinions of LifeDash,its agents and/or affiliates. Comments reflect the
                                    views and opinions of the person who post their views and opinions. To
                                    the extent permitted by applicable laws, LifeDash shall not be liable
                                ...
                                <p class="mt-2">
                                    LifeDash reserves the right to monitor all Comments and to remove any
                                ...
                                <p class="mt-2">
                                    You hereby grant LifeDash a non-exclusive license to use, reproduce,
                                ...
                                <p class="mt-2">
                                    ...
                                    the hyperlink compensates the absence of LifeDash; and (d) the link is
                                ...
                                <p class="mt-2">
                                    ...
                                    e-mail to LifeDash. Please include your name, your organization name,
                                ...
                                <p class="mt-2">
                                    No use of LifeDash's logo or other artwork will be allowed for linking
