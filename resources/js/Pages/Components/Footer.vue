        ...
        <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="//" class="flex items-center">
                        ...
                        <span
                            class="self-center text-2xl ml-2 font-semibold whitespace-nowrap dark:text-white">LifeDash</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <InertiaLink href="/privacy" target="_blank" class="hover:underline">Privacy</InertiaLink>
                            </li>
                            <li>
                                <InertiaLink href="/terms" target="_blank" class="hover:underline">Terms</InertiaLink>
                            </li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="https://github.com/stuxOS" target="_blank" class="hover:underline ">Github</a>
                            </li>
                            <li>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/"
                        class="hover:underline">LifeDash</a>.
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://twitter.com/stuxOS" target="_blank"
                        class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
